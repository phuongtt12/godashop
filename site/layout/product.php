...
<div class="button-product-action clearfix">
    ...
    <div class="quickview icon">
        <a class="btn btn-outline-inverse" href="<?=$router->generate("product-detail", ["slugName" => slugify($product->getName()), "id"=>$product->getId()])?>" title="<?=$product->getName()?>" title="Xem nhanh">
